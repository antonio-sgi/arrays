...
public class App 
{
    public static void main( String[] args )
    {
        ...
        */
        ...
        // La declaracion de un array de String, es decir, un array donde cada elemento es
        // de tipo String
       ...
       *se podria utilizar el operador new tambien, pero esta fuertemente desaconsejado 
       */
