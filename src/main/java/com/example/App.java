...
public class App {
  public static void main(String[] args) {
    ...
    // entre llaves separados por coma.
     ...
     * desaconsejado
     */
    String[] marcasDeCoche = { "Renault", "Tesla", "Toyota", "Mercedes" };
    ...
    // ¿Para que queda el for clasico? Para cuando necesitas utilizar el
     ...
     * 
     * Para demostrarlo: Vampos a crear un enum con los dias de la semana
   ...
   */
   ...
   String resultado = a > b ? "OK se cumple" : "No se cumple la condición";
  ...
  resultado = a != b ? "A es desigual B" : c != d ?
      "C desigual a D" : e == f ? "E igual a F" : "Final de las comparaciones";
  ...
  // de instrucciones siempre se va a ejecutar al menos una vez, aunque 
